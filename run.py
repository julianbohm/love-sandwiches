...
def get_sales_data():
    ...
    which must be s string of 6 numbers separated by commas. the loop will repeately
...
def update_sales_worksheet(data):
    """
    Update sales worksheet, add new row wih the list data provided.
    """
...
def update_surplus_worksheet(data):
    """
    Update surplus worksheet, add new row wih the list data provided.
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defines as the salesfigure subtracted from the stock:
